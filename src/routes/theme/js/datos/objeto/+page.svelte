<script lang="ts">
    ...
    import themeSource from '$lib/assets/theme/js/datos/objeto.yaml?raw';
...
<span class="font-mono font-bold text-white absolute  transition-all duration-300 ease-[cubic-bezier(0,.98,.26,1)] {themeId > 0 ? 'tracking-[-2rem] text-[10em] top-0 left-4' : 'tracking-[-5rem] text-[30em] -top-20 -left-10'}" 
    style="line-height:100%; -webkit-text-stroke: 1px var(--color-{themeColor}-600);">
    {themeNumb}
</span>
<span class="z-50 font-mono font-bold text-white absolute opacity-50 transition-all duration-300 ease-[cubic-bezier(0,.98,.26,1)] {themeId > 0 ? 'tracking-[-2rem] text-[10em] top-0 left-9' : 'tracking-[-5rem] text-[30em] -top-20 -left-2'}" 
    style="line-height:100%; -webkit-text-stroke: 1px var(--color-{themeColor}-600);">
    {themeNumb}
</span>
